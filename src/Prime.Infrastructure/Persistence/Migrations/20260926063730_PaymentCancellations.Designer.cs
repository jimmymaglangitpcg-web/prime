...
namespace Prime.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260926063730_PaymentCancellations")]
    partial class PaymentCancellations
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Prime.Domain.Entities.Collection.Payment", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<Guid?>("PayorTaxpayerId")
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("PayorTaxpayerId");

                    b.HasIndex("ReplacesPaymentId")
                        .IsUnique()
                        .HasFilter("\"ReplacesPaymentId\" IS NOT NULL");

                    b.HasIndex("TransactionNumber")
                        .IsUnique();

                    b.HasIndex("PaymentDate", "CashierUserId");

                    b.ToTable("Payments", null, t =>
                        {
                            t.HasCheckConstraint("CK_Payments_Amounts", "\"AmountDue\" > 0 AND \"Change\" >= 0 AND \"AmountTendered\" = \"AmountDue\" + \"Change\"");

                            t.HasCheckConstraint("CK_Payments_Cancelled", "(\"Status\" = 'Posted') = (\"CancelledAt\" IS NULL)");
                        });
                });

            modelBuilder.Entity("Prime.Domain.Entities.Collection.PaymentAllocation", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<Guid>("RevenueAccountMappingId")
                        .HasColumnType("uuid");
                    ...
                    b.Property<string>("YearCategory")
                        .IsRequired()
                        .HasMaxLength(20)
                        .HasColumnType("character varying(20)");
                    ...
                    b.HasIndex("RevenueAccountMappingId");

                    b.HasIndex("TaxBillId");
                    ...
                    b.HasIndex("RpuId", "TaxYear", "InstallmentSequence", "TaxTypeId");

                    b.ToTable("PaymentAllocations", null, t =>
                        {
                            t.HasCheckConstraint("CK_PaymentAllocations_Sign", "(\"Component\" = 'Discount' AND \"Amount\" < 0) OR (\"Component\" = 'Tax' AND \"Amount\" > 0) OR (\"Component\" IN ('Penalty', 'Interest') AND \"Amount\" >= 0)");
                        });
                });

            modelBuilder.Entity("Prime.Domain.Entities.Collection.PaymentCancellation", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<string>("ReplacementRequestJson")
                        .HasColumnType("jsonb");
                    ...
                    b.HasIndex("PaymentId")
                        .IsUnique()
                        .HasDatabaseName("UX_PaymentCancellations_Pending")
                    ...
                    b.ToTable("PaymentCancellations", null, t =>
                        {
                            t.HasCheckConstraint("CK_PaymentCancellations_Correction", "\"IsCorrection\" = (\"ReplacementRequestJson\" IS NOT NULL)");

                            t.HasCheckConstraint("CK_PaymentCancellations_Decision", "(\"Status\" = 'Pending') = (\"DecidedAt\" IS NULL) AND (\"Status\" = 'Approved') = (\"Kind\" IS NOT NULL AND \"TransactionNumber\" IS NOT NULL)");
                        });
                });

            modelBuilder.Entity("Prime.Domain.Entities.Collection.PaymentMode", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Prime.Domain.Entities.Collection.PaymentTender", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("PaymentTenders", null, t =>
                        {
                            t.HasCheckConstraint("CK_PaymentTenders_Amount", "\"Amount\" > 0");
                        });
                });

            modelBuilder.Entity("Prime.Domain.Entities.Collection.RevenueAccountMapping", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("TaxTypeId", "Component", "YearCategory")
                        .IsUnique()
                        .HasDatabaseName("UX_RevenueAccountMappings_OpenApproved")
                        .HasFilter("\"Status\" = 'Approved' AND \"EndDate\" IS NULL");

                    b.ToTable("RevenueAccountMappings", null, t =>
                        {
                            t.HasCheckConstraint("CK_RevenueAccountMappings_Approval", "(\"Status\" IN ('Approved', 'Posted')) = (\"ApprovedAt\" IS NOT NULL)");

                            t.HasCheckConstraint("CK_RevenueAccountMappings_EndDate", "\"EndDate\" IS NULL OR \"EndDate\" >= \"EffectiveDate\"");
                        });
                });
            ...
            modelBuilder.Entity("Prime.Domain.Entities.Notices.NoticeOfAssessmentItem", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<Guid>("NoticeOfAssessmentId")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Prime.Domain.Entities.Registers.RegisterRun", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Prime.Domain.Entities.SwornStatements.SwornStatement", b =>
                {
                    ...
                    b.Property<string>("AdministeringOfficer")
                        .HasMaxLength(300)
                        .HasColumnType("character varying(300)");
                    ...
                    b.Property<Guid?>("DeclarantTaxpayerId")
                        .HasColumnType("uuid");

                    b.Property<string>("DeclarantTin")
                        .HasMaxLength(50)
                        .HasColumnType("character varying(50)");
                    ...
                    b.Property<string>("IdentityDocumentIssuedAt")
                        .HasMaxLength(300)
                        .HasColumnType("character varying(300)");

                    b.Property<DateOnly?>("IdentityDocumentIssuedOn")
                        .HasColumnType("date");
                    ...
                    b.HasIndex("DeclarantName");

                    b.HasIndex("DeclarantTaxpayerId");
                    ...
                    b.HasIndex("SupersedesId")
                        ...
                        .HasFilter("\"SupersedesId\" IS NOT NULL AND \"Status\" <> 'Cancelled'");

                    b.HasIndex("MunicipalityId", "Status");

                    b.ToTable("SwornStatements", null, t =>
                        {
                            t.HasCheckConstraint("CK_SwornStatements_Cancelled", "(\"Status\" = 'Cancelled') = (\"CancelledAt\" IS NOT NULL)");

                            t.HasCheckConstraint("CK_SwornStatements_Filed", "(\"Status\" IN ('Filed', 'Superseded')) <= (\"FiledAt\" IS NOT NULL AND \"SignedOn\" IS NOT NULL AND \"SwornOn\" IS NOT NULL AND \"AdministeringOfficer\" IS NOT NULL AND \"ReceivedOn\" IS NOT NULL)");
                            ...
                            t.HasCheckConstraint("CK_SwornStatements_Witnesses", "NOT \"Thumbmarked\" OR \"Status\" = 'Draft' OR \"Status\" = 'Cancelled' OR (\"Witness1\" IS NOT NULL AND \"Witness2\" IS NOT NULL)");
                        });
                });

            modelBuilder.Entity("Prime.Domain.Entities.SwornStatements.SwornStatementItem", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<string>("AnnualProduct")
                        .HasMaxLength(200)
                        .HasColumnType("character varying(200)");
                    ...
                    b.Property<DateOnly?>("DateOperationCommenced")
                        .HasColumnType("date");

                    b.Property<decimal>("DeclaredMarketValue")
                        .HasPrecision(18, 2)
                        .HasColumnType("numeric(18,2)");
                    ...
                    b.Property<string>("ExistingTdNumber")
                        .HasMaxLength(100)
                        .HasColumnType("character varying(100)");
                    ...
                    b.Property<int?>("NonProductiveCount")
                        .HasColumnType("integer");
                    ...
                    b.Property<Guid>("SwornStatementId")
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("SwornStatementId", "Sequence")
                        .IsUnique();

                    b.ToTable("SwornStatementItems", null, t =>
                        {
                            t.HasCheckConstraint("CK_SwornStatementItems_Amounts", "COALESCE(\"AcquisitionCost\", 0) >= 0 AND COALESCE(\"InstallationCost\", 0) >= 0 AND COALESCE(\"Depreciation\", 0) >= 0 AND COALESCE(\"ProductiveCount\", 0) >= 0 AND COALESCE(\"NonProductiveCount\", 0) >= 0 AND COALESCE(\"Storeys\", 1) >= 1");

                            t.HasCheckConstraint("CK_SwornStatementItems_ExistingTd", "\"TaxDeclarationId\" IS NULL OR \"ExistingTdNumber\" IS NULL");

                            t.HasCheckConstraint("CK_SwornStatementItems_Kind", "(\"Kind\" = 'Land' AND \"Area\" > 0 AND \"AreaUnit\" IS NOT NULL) OR (\"Kind\" = 'Building' AND \"FloorArea\" > 0) OR (\"Kind\" = 'Machinery' AND \"Description\" IS NOT NULL) OR (\"Kind\" = 'OtherImprovement' AND \"ImprovementKindId\" IS NOT NULL)");
            ...
            modelBuilder.Entity("Prime.Domain.Entities.TaxDeclaration", b =>
                {
                    ...
                    b.Property<int?>("TransactionRank")
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Prime.Domain.Entities.Collection.Payment", b =>
                {
                    b.HasOne("Prime.Domain.Entities.Taxpayer", "PayorTaxpayer")
                        .WithMany()
                        .HasForeignKey("PayorTaxpayerId")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.HasOne("Prime.Domain.Entities.Collection.Payment", null)
                        .WithMany()
                        .HasForeignKey("ReplacesPaymentId")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.Navigation("PayorTaxpayer");
                });
            ...
            modelBuilder.Entity("Prime.Domain.Entities.Collection.PaymentAllocation", b =>
                {
                    ...
                    b.HasOne("Prime.Domain.Entities.Collection.RevenueAccountMapping", null)
                        .WithMany()
                        .HasForeignKey("RevenueAccountMappingId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
                    ...
                    b.HasOne("Prime.Domain.Entities.Billing.TaxBill", "TaxBill")
                        .WithMany()
                        .HasForeignKey("TaxBillId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
            ...
            modelBuilder.Entity("Prime.Domain.Entities.Collection.PaymentCancellation", b =>
                {
                    b.HasOne("Prime.Domain.Entities.Collection.Payment", "Payment")
                    ...
                    b.HasOne("Prime.Domain.Entities.Collection.Payment", null)
                        .WithMany()
                        .HasForeignKey("ReplacementPaymentId")
                        .OnDelete(DeleteBehavior.Restrict);
            ...
            modelBuilder.Entity("Prime.Domain.Entities.Collection.PaymentTender", b =>
                {
                    ...
                    b.HasOne("Prime.Domain.Entities.Collection.PaymentMode", "PaymentMode")
                        .WithMany()
            ...
            modelBuilder.Entity("Prime.Domain.Entities.Notices.NoticeOfAssessmentItem", b =>
                {
                    ...
                    b.HasOne("Prime.Domain.Entities.Notices.NoticeOfAssessment", null)
                        .WithMany("Items")
                        .HasForeignKey("NoticeOfAssessmentId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
            ...
            modelBuilder.Entity("Prime.Domain.Entities.SwornStatements.SwornStatement", b =>
                {
                    b.HasOne("Prime.Domain.Entities.Taxpayer", "DeclarantTaxpayer")
                        .WithMany()
                        .HasForeignKey("DeclarantTaxpayerId")
                        .OnDelete(DeleteBehavior.Restrict);
                    ...
                    b.HasOne("Prime.Domain.Entities.SwornStatements.SwornStatement", "Supersedes")
                        .WithMany()
                        .HasForeignKey("SupersedesId")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.Navigation("DeclarantTaxpayer");
            ...
            modelBuilder.Entity("Prime.Domain.Entities.SwornStatements.SwornStatementItem", b =>
                {
                    ...
                    b.HasOne("Prime.Domain.Entities.SwornStatements.SwornStatement", null)
                        .WithMany("Items")
                        .HasForeignKey("SwornStatementId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
